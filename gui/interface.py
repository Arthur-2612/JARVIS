...
class InterfaceJarvis:
    ...
    def _montar_layout(self):
        ...
        botao_pausar = tk.Button(
            botoes, text="PAUSAR", command=self._pausar_manual,
            bg="#2a3c4b", fg=COR_TEXTO, font=("Consolas", 9, "bold"),
            relief="flat", padx=10, cursor="hand2"
        )
        botao_pausar.pack(side="left", padx=(0, 6))

        botao = tk.Button(
            botoes, text="ENVIAR", command=self._enviar_manual,
        ...
        botao_fechar = tk.Button(
            botoes, text="SAIR", command=self._fechar_manual,
            bg="#4f1f2b", fg="#f3dfe4", font=("Consolas", 9, "bold"),
            relief="flat", padx=10, cursor="hand2"
        )
    ...
    def _pausar_manual(self):
        self.registrar_log("[sistema] Pausa manual ativada.")
        self.on_comando_manual("pausar")

    def _fechar_manual(self):
        self.registrar_log("[sistema] Encerramento solicitado pelo usuário.")
        self.on_comando_manual("encerrar jarvis")
