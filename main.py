...
class Jarvis:
    def __init__(self):
        ...
        if self.config.get("comportamento", {}).get("usar_palmas_como_gatilho_alternativo", True):
    ...
    def _loop_de_voz(self):
        ...
        while not self.encerrando:
            ...
            texto = ouvido.ouvir_comando(idioma=idioma, timeout=timeout, phrase_time_limit=limite_frase)
